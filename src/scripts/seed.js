...
const products = [
  ...
  { productName: 'Al Haramain Amber Oud Gold Edition Extrait 100ml', category: 'Oud', price: 849, oldPrice: 1149, stock: 10, image: [i('al-haramain-amber-oud-gold-edition-extrait-100ml.webp')], description: 'An extrait-strength masterpiece. Golden amber, saffron and rich agarwood bloom over a honeyed base — opulent, smooth and unmistakably expensive.' },
  ...
  { productName: 'Fragrance World Brown Orchid Oud Edition EDP 30ml', category: 'Oud', price: 379, oldPrice: 499, stock: 20, image: [i('fragrance-world-brown-orchid-oud-edition-edp-30ml.webp')], description: 'Velvet orchid petals resting on a cushion of smoked oud and sandalwood. Sophisticated, unisex and intensely addictive.' },
  ...
  { productName: 'Emper Sovereign Candy Flora EDP 100ml', category: 'Floral', price: 579, oldPrice: 749, stock: 13, image: [i('emper-sovereign-candy-flora-edp-100ml.webp')], description: 'Candied peonies and rose petals over a sugar-soft base. Playful floral sweetness with a champagne fizz.' },
  ...
  { productName: 'Bentley Momentum Intense EDP 100ml', category: 'Woody', price: 1249, oldPrice: 1599, stock: 6, image: [i('bentley-momentum-intense-edp-100ml.webp')], description: 'An intense masculine gut-punch — spicy lavender, black coffee and warm woods. Brisk, powerful and exceptionally refined.' },
  ...
  // ——— Oriental ———
  { productName: 'Armaf Odyssey Mega gift set EDP 100ml', category: 'Oriental', price: 1149, oldPrice: 1499, stock: 6, image: [i('armaf-odyssey-mega-gift-set-edp-100ml.webp')], description: 'A mega-wearer favourite: saffron, rich amber and incense layered into a deep oriental base. Grand, exotic and envelope-pushing.' },
  { productName: 'Lattafa Queen of Arabia gift set EDP 100ml', category: 'Oriental', price: 829, oldPrice: 1099, stock: 8, image: [i('lattafa-queen-of-arabia-gift-set-edp-100ml.webp')], description: 'Regal oriental opulence — oud, rose and spices with a honeyed amber glow. A jewelled gift set for the queen in your life.' },
